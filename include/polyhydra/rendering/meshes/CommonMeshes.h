...
struct CommonMeshes
{
    ...
    struct PlaneXY
    {
        ...
        inline static std::vector<float> vertices(float size_x = 1.0f, float size_y = 1.0f, float offset_z = 0.0f)
        {
            ...
            return std::vector<float>{-half_size_x,
                                      half_size_y,
                                      offset_z,
                                      -half_size_x,
                                      -half_size_y,
        ...
        {
            return std::vector<uint32_t>{offset + 0, offset + 1, offset + 2, offset + 2, offset + 3, offset + 0};
        }
        ...
        {
            return std::vector<float>{0.0, 0.0, 0.0, 1.0, 1.0, 1.0, 1.0, 0.0};
        }
