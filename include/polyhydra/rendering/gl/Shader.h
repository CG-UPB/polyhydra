...
class Shader
{
  public:
     ...
     * Utility shaders.
     */
    static std::shared_ptr<Shader> background_shader()
    {
        return get("background");
    }
    // static std::shared_ptr<Shader> ground_shader() { return get("ground"); }
    static std::shared_ptr<Shader> basic_shape_shader()
    {
        return get("basic_shape");
    }
    static std::shared_ptr<Shader> quad_circle_shader()
    {
        return get("quad_circle");
    }
    static std::shared_ptr<Shader> flat_color_shader()
    {
        return get("flat_color");
    }
    static std::shared_ptr<Shader> vertex_only_shader()
    {
        return get("vertex_only");
    };

    /**
     * SelectionMode shaders.
     */
    static std::shared_ptr<Shader> selection_face()
    {
        return get("selection_face");
    }
    static std::shared_ptr<Shader> selection_vertex_shader()
    {
        return get("selection_vertex");
    }
    static std::shared_ptr<Shader> selection_edge_shader()
    {
        return get("selection_edge");
    }
    static std::shared_ptr<Shader> edge_hover_shader()
    {
        return get("edge_hover");
    }
    static std::shared_ptr<Shader> pre_mesh_phong_shader()
    {
        return get("pre_mesh_phong");
    }
  ...
  private:
     ...
     */
    Shader(const FS_NAMESPACE::path& vertexPath,
           const FS_NAMESPACE::path& fragmentPath,
           const FS_NAMESPACE::path& geometryPath,
           const FS_NAMESPACE::path& tessellationControlPath,
           const FS_NAMESPACE::path& tessellationEvaluationPath);
