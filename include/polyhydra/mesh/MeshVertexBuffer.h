...
enum class Attribute
{
    ...
    DIHEDRAL_ANGLE,
    SELECTION,
    SELECTION_VERTEX_POSITION,
    SELECTION_FROM_VERTEX,
    SELECTION_TO_VERTEX,
    HOVERED,
    VERTEX_NORMAL,
    MIN_EDGE_LEN
...
class MeshVertexBuffer
{
  public:
    ...
    glm::vec3 get_min_bounding_box()
    {
        return min_bounding_box;
    }
    glm::vec3 get_max_bounding_box()
    {
  ...
  private:
    ...
    uint32_t add_vertex_data_to_cell_data(RoundedCellData& data,
                                          float type,
                                          const glm::vec3& pos,
    ...
    void add_from_to_vertex(const std::shared_ptr<OVMesh>& mesh,
