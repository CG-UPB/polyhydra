...
/**
 * Open polyhydra context and start rendering
 */
void open();

/**
 * Close polyhydra context
 */
void close();
...
[[nodiscard]] VMesh load(const OpenVolumeMesh::GeometryKernel<OpenVolumeMesh::Vec3d, KernelType>* instance,
...
/**
 * Remove all meshes from polyhydra.
 */
void clear();

/**
 * Remove mesh from polyhydra.
...
/**
 * Set the color theme of polyhydra
 * @param theme
 * Light: Lightmode
 * Dark:  Darkmode
 */
...
struct VShape
{
    ...
    {
        polyhydra::set_position(*this, x, y, z);
    }
    ...
    {
        polyhydra::set_position<Vec3T>(*this, position);
    }
    ...
    {
        polyhydra::set_direction(*this, axis_x, axis_y, axis_z, angle);
    }
    ...
    {
        polyhydra::set_direction<Vec3T>(*this, axis, angle);
    }
    ...
    {
        polyhydra::set_scale(*this, x, y, z);
    }
    ...
    {
        polyhydra::set_scale(*this, scalar);
    }
    ...
    {
        polyhydra::set_scale<Vec3T>(*this, scale);
    }
    ...
    {
        polyhydra::set_color<Vec4T>(*this, color);
    }
    ...
    {
        return polyhydra::get_position<Vec3T>(*this);
    }
    ...
    {
        return polyhydra::get_scale<Vec3T>(*this);
    }

    /**
     * Returns the internal polyhydra id of this shape
     *
     * @return internal id
     */
...
struct VArrow : public VShape
{
    ...
    {
        polyhydra::set_tip_height(*this, tip_height);
    }
    ...
    {
        polyhydra::set_base_width(*this, base_width);
    }
};
...
struct VMesh
{
    ...
    {
        polyhydra::update(*this, instance);
    }
    ...
    {
        polyhydra::load_configuration(*this, path);
    }
    ...
    {
        polyhydra::save_configuration(*this, path);
    }
    ...
    {
        polyhydra::set_rendering_mode(*this, mode);
    }

    inline void render_cells(bool cells)
    {
        polyhydra::render_cells(*this, cells);
    }

    inline void render_lines(bool lines)
    {
        polyhydra::render_lines(*this, lines);
    }

    inline void render_points(bool points)
    {
        polyhydra::render_points(*this, points);
    }

    template <typename Vec3T>
    inline void set_line_color(Vec3T color) const
    {
        polyhydra::set_line_color<Vec3T>(*this, color);
    }

    template <typename Vec3T>
    inline void set_point_color(Vec3T color) const
    {
        polyhydra::set_point_color<Vec3T>(*this, color);
    }

    inline bool is_rendering_cells() const
    {
        return polyhydra::is_rendering_cells(*this);
    }

    inline bool is_rendering_lines() const
    {
        return polyhydra::is_rendering_lines(*this);
    }

    inline bool is_rendering_points() const
    {
        return polyhydra::is_rendering_points(*this);
    }

    template <typename Vec3T>
    [[nodiscard]] inline Vec3T get_line_color() const
    {
        return polyhydra::get_line_color<Vec3T>(*this);
    }

    template <typename Vec3T>
    [[nodiscard]] inline Vec3T get_point_color() const
    {
        return polyhydra::get_point_color<Vec3T>(*this);
    }
    ...
    {
        polyhydra::set_point_size(*this, size);
    }
    ...
    {
        return polyhydra::get_point_size(*this);
    }
    ...
    {
        polyhydra::set_line_width(*this, width);
    }
    ...
    {
        return polyhydra::get_line_width(*this);
    }
    ...
    {
        polyhydra::set_shading_mode(*this, mode);
    }
    ...
    {
        return polyhydra::get_shading_mode(*this);
    }
    ...
    {
        polyhydra::use_backface_culling(*this, culling);
    }
    ...
    {
        return polyhydra::is_using_backface_culling(*this);
    }
    ...
    {
        return polyhydra::is_using_two_sided_lighting(*this);
    }
    ...
    {
        polyhydra::use_two_sided_lighting(*this, ts_lighting);
    }
    ...
    {
        return polyhydra::is_using_base_color(*this);
    }
    ...
    {
        polyhydra::use_base_color(*this, base_color);
    }
    ...
    {
        polyhydra::set_color<Vec4T>(*this, cell, color);
    }
    ...
    {
        polyhydra::set_color<Vec4T>(*this, face, color);
    }
    ...
    {
        polyhydra::set_color<Vec4T>(*this, halfface, color);
    }
    ...
    {
        return polyhydra::get_color<Vec4T>(*this);
    }
    ...
    {
        return polyhydra::get_color<Vec4T>(*this, cell);
    }
    ...
    {
        return polyhydra::get_color<Vec4T>(*this, halfface);
    }
    ...
    {
        polyhydra::select(*this, halfface);
    }
    ...
    {
        polyhydra::deselect(*this, halfface);
    }
    ...
    {
        polyhydra::deselect(*this, vertex);
    }
    ...
    {
        polyhydra::reset_selection(*this);
    }
    ...
    {
        polyhydra::set_ambient(*this, ambient);
    }
    ...
    {
        return polyhydra::get_ambient(*this);
    }
    ...
    {
        polyhydra::set_diffuse(*this, diffuse);
    }
    ...
    {
        return polyhydra::get_diffuse(*this);
    }
    ...
    {
        polyhydra::set_specular(*this, specular);
    }
    ...
    {
        return polyhydra::get_specular(*this);
    }
    ...
    {
        polyhydra::set_specular_coefficient(*this, coefficient);
    }
    ...
    {
        return polyhydra::get_specular_coefficient(*this);
    }
    ...
    {
        polyhydra::set_lighting_mode(*this, mode);
    }
    ...
    {
        return polyhydra::get_lighting_mode(*this);
    }
    ...
    {
        polyhydra::set_metallic(*this, metallic);
    }
    ...
    {
        return polyhydra::get_metallic(*this);
    }
    ...
    {
        polyhydra::set_roughness(*this, roughness);
    }
    ...
    {
        return polyhydra::get_roughness(*this);
    }

    template <typename Vec3T>
    inline void set_origin(const Vec3T& origin) const
    {
        polyhydra::set_origin<Vec3T>(*this, origin);
    }

    template <typename Vec3T>
    inline Vec3T get_origin() const
    {
        return polyhydra::get_origin<Vec3T>(*this);
    }
    ...
    {
        polyhydra::set_scale(*this, scale);
    }
    ...
    {
        return polyhydra::get_scale(*this);
    }
    ...
    {
        return polyhydra::use_scale_normalization(*this, use_scale_norm);
    }
    ...
    {
        polyhydra::set_rotation(*this, x, y, z);
    }
    ...
    {
        polyhydra::set_rotation<Vec3T>(*this, rotation);
    }
    ...
    {
        polyhydra::set_rotation<Vec3T>(*this, angle, axis);
    }
    ...
    {
        return polyhydra::get_rotation<Vec3T>(*this);
    }
    ...
    {
        return polyhydra::get_transformed_point<Vec3T>(*this, point);
    }
    ...
    {
        polyhydra::set_slice_factor(*this, factor);
    }
    ...
    {
        return polyhydra::get_slice_factor(*this);
    }
    ...
    {
        polyhydra::set_slice_locked(*this, lock);
    }
    ...
    {
        return polyhydra::get_slice_locked(*this);
    }
    ...
    {
        polyhydra::set_peel_level(*this, level);
    }
    ...
    {
        return polyhydra::get_peel_level(*this);
    }
    ...
    {
        polyhydra::use_reverse_peeling(*this, reverse);
    }
    ...
    {
        return polyhydra::is_using_reverse_peeling(*this);
    }
    ...
    {
        return polyhydra::get_max_peel_depth(*this);
    }
    ...
    {
        polyhydra::set_cell_rounding(*this, rounding);
    }
    ...
    {
        return polyhydra::get_cell_rounding(*this);
    }
    ...
    {
        return polyhydra::get_tessellation_level(*this);
    }
    ...
    {
        polyhydra::set_tessellation_level(*this, level);
    }
    ...
    {
        polyhydra::set_cell_size(*this, size);
    }
    ...
    {
        return polyhydra::get_cell_size(*this);
    }
    ...
    {
        polyhydra::set_focused_mesh(*this);
    }
    ...
    {
        return polyhydra::get_focused_mesh().m_id == m_id;
    }
    ...
    {
        polyhydra::set_visibility(*this, cell, visible);
    }
    ...
    {
        return polyhydra::get_visibility(*this, cell);
    }
    ...
    {
        polyhydra::set_visibility(*this, visible);
    }
    ...
    {
        return polyhydra::get_visibility(*this);
    }
    ...
    {
        polyhydra::reset_visibility(*this);
    }
    ...
    {
        polyhydra::never_discard(*this, cell);
    }
    ...
    {
        return polyhydra::get_name(*this);
    }
    ...
    [[nodiscard]] inline ShapeType add_shape() const
    {
        ...
        return polyhydra::add_shape<ShapeType>(*this);
    }
    ...
    {
        static_assert(std::is_base_of_v<VShape, ShapeType>);
        return polyhydra::add_shape<ShapeType>(*this, cell);
    }
    ...
    {
        return polyhydra::is_valid(*this);
    }
    ...
    {
        return polyhydra::is_bezier_mesh(*this);
    }

    /**
     * Returns the internal polyhydra id of this mesh
     * @return internal id
     */
    [[nodiscard]] int get_id() const
    {
