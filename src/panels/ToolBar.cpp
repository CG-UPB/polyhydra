...
//        if (ImGui::BeginPopup("Selection")) {
           if (ImGui::CollapsingHeader("Selection")) {
                ...
                if (m_selection_activated) {
                    ...
                    ImGui::SameLine();
                    HelpMarkerWithQuestionMark("This button will select the nearest Vertex, Edge or Face of your pick");
                    ...
                    ImGui::SameLine();
                    HelpMarkerWithQuestionMark("This button will select the nearest Vertex of your pick");
                    ...
                    ImGui::SameLine();
                    HelpMarkerWithQuestionMark("This button will select the nearest Edge of your pick");
                    ...
                    ImGui::SameLine();
                    HelpMarkerWithQuestionMark("This button will select the nearest Face of your pick");
                }
            }
            ...
            if (ImGui::CollapsingHeader("Active Mesh Settings")) {
                if (ImGui::BeginTable("split1", 1)) {
                    ...
                    ImGui::Text("Position:");
                    ImGui::SameLine();
                    HelpMarkerWithQuestionMark("Adjust the mesh position");
                    if (ImGui::DragFloat3("##Position", m_mesh_position, 0.1f, -10.0f, 10.0f, "%.1f")) {
                        if (active_mesh >= 0) {
                            Window::instance().rendering_mutex.unlock();
                            Window::instance().set_mesh_position(active_mesh, m_mesh_position[0], m_mesh_position[1],
                                                                 m_mesh_position[2]);
                            Window::instance().rendering_mutex.lock();
                        }
                    }
                    ...
                    ImGui::Text("Scale:");
                    ImGui::SameLine();
                    HelpMarkerWithQuestionMark("Adjust the mesh scale");
                    ...
                    ImGui::Text("Slicer:");
                    ImGui::SameLine();
                    HelpMarkerWithQuestionMark("This slider will slice through the mesh to show an "
                                               "inview of the mesh");
                    ...
                    ImGui::Text("Peel:");
                    ImGui::SameLine();
                    HelpMarkerWithQuestionMark("This slider will peel the mesh like an onion");
                    ...
                    ImGui::SameLine();
                    HelpMarkerWithQuestionMark("This slider will change the size of each cell");
                    ...
                    ImGui::SameLine();
                    HelpMarkerWithQuestionMark("With this button you can start a selection of a "
