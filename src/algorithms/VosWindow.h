...
public:
    ...
    /*
     * Tells Vos that vertices from the given vertex array have been modified by the programmer
     * TODO: Only for Vertices at the moment
     */
    void UpdateVertices(OpenVolumeMesh::VertexHandle* vertices_array);
