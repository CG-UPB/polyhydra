...
namespace vOS {
    ...
    void TestClass::start() {
        ...
        // Create mesh object
// Add eight vertices
        OpenVolumeMesh::VertexHandle v0 = myMesh.add_vertex(OpenVolumeMesh::Vec3d(-1.0, 0.0, 0.0));
        OpenVolumeMesh::VertexHandle v1 = myMesh.add_vertex(OpenVolumeMesh::Vec3d( 0.0, 0.0, 1.0));
        OpenVolumeMesh::VertexHandle v2 = myMesh.add_vertex(OpenVolumeMesh::Vec3d( 1.0, 0.0, 0.0));
        OpenVolumeMesh::VertexHandle v3 = myMesh.add_vertex(OpenVolumeMesh::Vec3d( 0.0, 0.0,-1.0));
        OpenVolumeMesh::VertexHandle v4 = myMesh.add_vertex(OpenVolumeMesh::Vec3d( 0.0, 1.0, 0.0));
