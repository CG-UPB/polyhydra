...
namespace volumeshOS::Internal
{
    ...
    void Window::load_light_mode()
    {
        ...
        colors[ImGuiCol_TitleBgActive]          = ImVec4(0.72f, 0.72f, 0.72f, 1.00f);
        colors[ImGuiCol_TitleBgCollapsed]       = ImVec4(0.67f, 0.67f, 0.67f, 1.00f);
        ...
        colors[ImGuiCol_SliderGrab]             = ImVec4(0.57f, 0.59f, 0.60f, 1.00f);
        colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.57f, 0.58f, 0.60f, 1.00f);
        ...
        colors[ImGuiCol_Tab]                    = ImVec4(0.87f, 0.87f, 0.87f, 1.00f);
