...
namespace volumeshOS::Internal
{
    ...
    void Window::load_dark_mode()
    {
        ...
        colors[ImGuiCol_TitleBg]                = ImVec4(0.17f, 0.20f, 0.24f, 1.00f);
        colors[ImGuiCol_TitleBgActive]          = ImVec4(0.19f, 0.22f, 0.26f, 1.00f);
