...
Shader::Shader(const FS_NAMESPACE::path& vertexPath,
...
void Shader::load_all()
{
    ...
    {
        s_shaders[shader_source_path.first]
            = std::shared_ptr<Shader>(new Shader(shader_source_path.second.vertex,
    ...
    s_shaders["transparency_wb"] = std::shared_ptr<Shader>(new Shader(pre_mesh_phong_path / "mesh_phong.vert",
                                                                      transparency_path / "transparency_wb.frag",
                                                                      pre_mesh_phong_path / "",
                                                                      pre_mesh_phong_path / "mesh_phong.tesc",
                                                                      pre_mesh_phong_path / "mesh_phong.tese"));
    s_shaders["transparency_dp"] = std::shared_ptr<Shader>(new Shader(pre_mesh_phong_path / "mesh_phong.vert",
