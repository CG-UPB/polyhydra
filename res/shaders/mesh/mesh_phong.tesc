...
void main()
{
    ...
    if (ID == 0) 
    {
        ...
        if(u_is_bezier_mesh) 
        {
            ...
            {
                gl_TessLevelInner[0] = 20; //u_bezier_tessellation_level;
            }
            gl_TessLevelOuter[0] = 20; //u_bezier_tessellation_level;
            gl_TessLevelOuter[1] = 20; //u_bezier_tessellation_level;
            gl_TessLevelOuter[2] = 20; //u_bezier_tessellation_level;
        }
        else
        {
