...
void main()
{
    ...
    vertex(screen_pos0, pos0.xyz, v_Normal[0], get_color(0, 1, 2) , v_Visible[0], v_tesInnerTri[0]);

    set_light_space_pos(1);
    v_tri_dist = vec3(0.0, 0.0, dist1);
    vertex(screen_pos1, pos1.xyz, v_Normal[1], get_color(1, 0, 2) , v_Visible[1], v_tesInnerTri[1]);

    set_light_space_pos(2);
    v_tri_dist = vec3(dist2, 0.0, 0.0);
    vertex(screen_pos2, pos2.xyz, v_Normal[2], get_color(2, 0, 1) , v_Visible[2],v_tesInnerTri[2]);
